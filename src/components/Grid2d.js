...
export default function Grid(){
   ...
   const override = 
    ...
    function searchText(e){
        ...
        console.log(search);
        if(search !==""){
            setText(newArr.filter((name)=>(name.temp.includes(search)
            )))
            setRender(!render)
        }
        else{
        ...
        return(
            ...
            <div className='container p-5 border shadow w-50 bg-light'>
                <div className='mb-3'>
                    ...
                    <input type="text" id="num of rows" onChange={handleChange} name="rows"/>
                </div>
                <div>
                    <span style={{color:"blue"}}> Number of Columns:</span>
                    <input type="text" id="num of cols" onChange={handleChange} name="columns"/>
                </div>
                <div className='p-4'>
            ...
            <div className='container-fluid mt-4'>
                <form className='d-flex d-grid gap-3 col-2 mx-auto lg'>
                    <input className='form-control' type="text" onChange={searchText} placeholder="Search text" arial-label="search"/>
